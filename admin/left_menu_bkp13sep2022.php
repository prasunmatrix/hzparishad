...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            <!-- Dashboard -->
            <li class="menu-item <?php if ($activePage=="tender"||$activePage=="addtender"||$activePage=="edittender") {echo "active"; } else  {echo "noactive";}?>">
              <a href="tender.php" class="menu-link">
                <i class="menu-icon tf-icons bx bx-home-circle"></i>
                <div data-i18n="Analytics">Tender Management</div>
              </a>
            </li>
            <li class="menu-item <?php if ($activePage=="notice"||$activePage=="addnotice"||$activePage=="editnotice") {echo "active"; } else  {echo "noactive";}?>"">
